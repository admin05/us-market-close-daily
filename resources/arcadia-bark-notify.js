const DEFAULT_BARK_GROUP = 'concept-fund-allocator';
...
export async function sendBark({ title, body, group = DEFAULT_BARK_GROUP }) {
  const endpoint = normalizeBarkEndpoint(process.env.BARK);
  if (!endpoint) {
